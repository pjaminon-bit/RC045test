...
require_once __DIR__.'/app/security/registration-rate-limit.php';
...
function aanmeldenRateLimitPaden(): array
{
    $privateRoot=tenantRuntimePrivateRoot(siteConfig());
    if($privateRoot!==null){
        $map=$privateRoot.'/security';
        return[$map.'/aanmelden-pogingen.json',$map.'/.aanmelden-pogingen.lock'];
    }
    return[__DIR__.'/aanmelden-pogingen.php',__DIR__.'/data-backups/.aanmelden-pogingen.lock'];
}
