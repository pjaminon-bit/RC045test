...
function apply46Deps(array$p):string
{
    ...
    $php='/usr/bin/php'.(string)$p['runtime']['php_version'];if(!preg_match('#^/usr/bin/php[0-9]{1,2}\.[0-9]{1,2}$#D',$php)||!is_file($php)||!is_executable($php))throw new RuntimeException('Exacte tenant-PHP CLI ontbreekt: '.$php);
    return$php;
}
