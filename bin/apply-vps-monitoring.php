...
$adapterFout=monitoring46AlertAdapterFout((array)$p['alerts']);if($adapterFout!==null)apply46Stop('Alerting enabled maar provisioning weigert activatie: '.monitoring46AlertAdapterFoutMelding($adapterFout));
