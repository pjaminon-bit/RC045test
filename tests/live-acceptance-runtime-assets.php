...
a(str_contains($leden,'href="csp205-index-41371aa64bd2.css"')&&str_contains($ledenLoginCss,'.wrap button{min-height:44px!important'),'leden-loginbutton heeft minimaal 44px hoogte via het geladen CSP-stylesheet');
