...
c59(str_contains($adminExec,"'Content & branding gereed'")&&str_contains($adminExec,"'Export & herstel bewezen'")&&str_contains($adminExec,"'Pilot gereed'"),'snapshot maakt branding, recovery en finale pilotstatus afzonderlijk zichtbaar');
