...
$acceptCall=strrpos($exec,'control59PilotAcceptance($c,$state');$adoptCall=strpos($exec,"'--adopt-active'");c59($acceptCall!==false&&$adoptCall!==false&&$acceptCall<$adoptCall,'pilotacceptatie draait vóór lifecycle als voltooid wordt geadopteerd');
