...
try{
 ...
 $ops=(string)file_get_contents($root.'/app/control-plane/control-plane-operations.php');$ui=(string)file_get_contents($root.'/app/control-plane-web/index.php');$uiCss=(string)file_get_contents($root.'/app/control-plane-web/csp205-index-d8d9c9066d8d.css');$js=(string)file_get_contents($root.'/app/control-plane-web/app.js');
 ...
 c517(str_contains($ui,'href="csp205-index-d8d9c9066d8d.css"')&&str_contains($uiCss,'@media(max-width:1080px){.system-grid,.meta{'),'responsive tenantdiagnostiek gebruikt geldige zelfstandige mediaregel via het geladen CSP-stylesheet');
