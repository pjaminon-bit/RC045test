...
try{
 ...
 $sys=cpAdminSysteemStatus($snapshot);
 ...
 c516(($sys['privileged_ops']['status']??'')==='unknown','capaciteitstest zonder rootmeting markeert privileged integriteit expliciet onbekend');
