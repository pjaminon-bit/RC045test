...
try{
 ...
 c45(($dry['postgresql']['hba_include_directive']??'')==='include_dir "/etc/verenigingsplatform/postgresql/pg_hba.d"','databaseplan gebruikt geldige PostgreSQL HBA include_dir quoting');
