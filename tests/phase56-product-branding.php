...
try{
 $basis=['vereniging'=>['sleutel'=>'morgen-club','naam'=>'Morgen Club','volledige_naam'=>'Morgen Club Nederland','slogan'=>'Samen actief','site_url'=>'https://morgen.example'],'branding'=>['logo'=>'','favicon'=>'','kleuren'=>[]],'betaling'=>[],'opslag'=>['private_root'=>$private]];
 $input=['vereniging'=>['naam'=>'Morgen Club','volledige_naam'=>'Morgen Club Nederland','slogan'=>'Samen actief'],'branding'=>['logo'=>'','favicon'=>'','theme_color'=>'#112233','kleuren'=>['primary'=>'#345678','primary_dark'=>'#234567','primary_light'=>'#EAF0F4','accent'=>'#CC8800','accent_light'=>'#FFF4DD','dark'=>'#112233','text'=>'#223344','muted'=>'#667788','background'=>'#F5F7F9','nav_background'=>'#101820','nav_text'=>'#FFFFFF']],'betaling'=>['iban'=>'NL91ABNA0417164300','tenaamstelling'=>'Morgen Club Nederland','omschrijving'=>'Contributie {jaar} - {naam}']];
 ...
 c56(str_contains($uit,'images/template-placeholder.svg'),'voorbeeldmedia wordt door neutrale placeholder vervangen');
