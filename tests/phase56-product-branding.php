...
try{
 ...
 $html='<!doctype html><html><head><link rel="icon" href="favicon.ico"><script data-goatcounter="https://rc045.goatcounter.com/count" src="//gc.zgo.at/count.js"></script></head><body><nav class="nav"><span class="nav-logo-text">RC045</span></nav><img src="rc045-logo.png" alt="RC045"><img src="images/crawlergroen.jpg"><p>RC045 – Bashers of the South · Eygelshoven · Wijngaardsberg 26 · bestuur@rc045.nl · NL51 RABO 0367 6153 63</p><form id="aanmeld-form" action="https://legacy-form-provider.invalid/f/voorbeeld"><button>stuur</button></form><script>fetch(\'aanmelden-ontvangst.php\', {method:\'POST\'}).catch(function(){});</script></body></html>';
 $uit=tenantPublicRuntimeTransform($html,$config);
 foreach(['rc045','bashers of the south','eygelshoven','wijngaardsberg','bestuur@rc045.nl','nl51 rabo 0367 6153 63','goatcounter.com','legacy-form-provider.invalid']as$verboden)c56(stripos($uit,$verboden)===false,'uitvoer bevat geen '.$verboden);
