...
foreach(['index.php','groep-relaties.php','taken.php','vergaderingen.php','evenementen.php','ledenlabels.php','groepsrollen.php','operationele-taken.php'] as $bestand){$txt=t26txt($root.'/beheer/'.$bestand);t26(strpos($txt,'ui-2026.css')!==false,$bestand.' laadt Beheer UI 2026');}
