...
$readers = [
    ...
    'groepen-opslag.php' => "legacyPrivateJsonLees(groepenBestandPad(),'groepen',['rollen','groepen'])",
    'ledenlabels-opslag.php' => "legacyPrivateJsonLees(ledenlabelsBestandPad(),'ledenlabels',['labels','toewijzingen'])",
