...
$commissie=['baancommissie'=>['bestuurslid_id'=>'lid_test','hoofd_lid_id'=>'lid_test','leden'=>['lid_test','ander']]];ledenServicePurgeId($commissie,'lid_test');d25(($commissie['baancommissie']['bestuurslid_id']??null)==='','privacy purge wist bestuurslid_id');d25(($commissie['baancommissie']['hoofd_lid_id']??null)==='','privacy purge wist hoofd_lid_id');d25(($commissie['baancommissie']['leden']??[])===['ander'],'privacy purge verwijdert commissielid uit ledenlijst');
