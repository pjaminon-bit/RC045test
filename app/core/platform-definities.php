...
return [
    'features' => [
        ...
        'fotoboek' => ['label'=>'Fotoboek','type'=>'publiek','publieke_paginas'=>['fotoboek'],'publieke_links'=>['fotoboek.html'],'publieke_selectors'=>[],'beheer_tabs'=>['fotoboek'],'beheer_formulieren'=>['fotoboek_tekst','fotoboek_album_aanmaken','fotoboek_album_bewerken'],'leden_tabs'=>[],'leden_formulieren'=>[]],
        'media' => ['label'=>'Media','type'=>'publiek','publieke_paginas'=>['media'],'publieke_links'=>['media.html'],'publieke_selectors'=>[],'beheer_tabs'=>['media'],'beheer_formulieren'=>['media','media_tekst'],'leden_tabs'=>[],'leden_formulieren'=>[]],
        'aanmelden' => ['label'=>'Aanmelden','type'=>'publiek','publieke_paginas'=>['aanmelden','bedankt'],'publieke_links'=>['aanmelden.html','bedankt.html'],'publieke_selectors'=>[],'beheer_tabs'=>['aanmelden','bedankt','faq','aanmeldingen'],'beheer_formulieren'=>['aanmelden','bedankt','faq'],'leden_tabs'=>[],'leden_formulieren'=>[],'verberg_nav_lid'=>true],
        'evenementen' => ['label'=>'Evenementen','type'=>'hybride','publieke_paginas'=>[],'publieke_links'=>[],'beheer_tabs'=>['agenda'],'beheer_formulieren'=>['agenda'],'leden_tabs'=>[],'leden_formulieren'=>[],'publieke_selectors'=>['#activiteiten','a[href="index.html#activiteiten"]','a[href="#activiteiten"]','#footer-link-calendar']],
        'sponsors' => ['label'=>'Sponsors','type'=>'publiek','publieke_paginas'=>[],'publieke_links'=>[],'beheer_tabs'=>['sponsors'],'beheer_formulieren'=>['sponsors'],'leden_tabs'=>[],'leden_formulieren'=>[],'publieke_selectors'=>['.footer-sponsors','#footer-link-sponsor','#sponsors-grid','#footer-sponsors-title','#footer-sponsors-cta']],
    ],
    ...
    'beheer' => [
        ...
        'backups'=>['label'=>'Back-ups','categorie'=>'Beheer','route'=>'backups.php','capability'=>'system.backups.manage','gevoelig'=>true],
    ],
