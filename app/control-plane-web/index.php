...
<link rel="stylesheet" href="csp205-index-d8d9c9066d8d.css">
...
<section class="card"><div class="head"><div><h2>Onboarding</h2><div class="host">Verenigingen die nog niet volledig operationeel zijn.</div></div><a class="btn secondary" href="/?section=onboarding">Open wizard</a></div><?php $shown=0;foreach($tenants as$t):if(!is_array($t))continue;$ob=cpSuiteOnboarding($t);if($ob['percent']>=100)continue;$shown++;?><div class="mini csp-i-fe3c94c16f"><strong><?=h51((string)($t['name']??$t['tenant_key']))?></strong><div class="progress"><span class="csp-progress-<?=$ob['percent']?>"></span></div><small><?=$ob['done']?> / <?=$ob['total']?> stappen · <?=$ob['percent']?>%</small></div><?php endforeach;?><?php if($shown===0):?><div class="empty csp-i-df928149c5">Geen open onboarding.</div><?php endif;?></section>
</div></div>
