...
<p class="meta">Tenant-snapshots staan uitsluitend onder de private opslag van <strong><?=buEsc(tenantBackupTenantKey())?></strong>. Data-snapshots zijn cryptografisch aan tenant + onderdeel gebonden; Fotoboek- en sponsorbestanden gebruiken tenantgebonden manifests.</p>
