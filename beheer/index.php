...
require_once dirname(__DIR__) . '/leden-opslag.php';
...
$fotoboekMap     = dirname(__DIR__) . '/images/fotoboek';
$logoPad         = dirname(__DIR__) . '/rc045-logo.png';
...
$changelogVastPad = dirname(__DIR__) . '/changelog-historie.php';
...
<body>
  <div class="kaart">
    ...
    <p>Voor dit account staat geen enkel beheertabblad aan. Het ledengedeelte vind je op <a href="../leden/">de ledenpagina</a>.</p>
...
<head>
  ...
  <link rel="stylesheet" href="../paneel.css?v=<?php echo @filemtime(dirname(__DIR__) . '/paneel.css'); ?>">

  <script src="../paneel-thema.js?v=<?php echo @filemtime(dirname(__DIR__) . '/paneel-thema.js'); ?>"></script>
</head>
<body>
  ...
  <?php else: ?>
    ...
    <form method="post" action="./#ontstaan">
    ...
    <form method="post" action="./#baanreglement">
    ...
    <div class="kaart">
      ...
      <form method="post" action="./#mededeling">
    ...
    <div class="kaart">
      ...
      <form method="post" action="./#nieuws">
    ...
    <div class="kaart">
      ...
      <?php endif; ?>
      <form method="post" action="./#fotoboek">
    ...
    <?php foreach ($fotoboekData['albums'] as $album): $slug = $album['slug']; ?>
      <div class="kaart">
        <details class="fotoboek-album-details" data-taal-scope="fotoboek-album-<?php echo htmlspecialchars($slug); ?>">
          ...
          <form method="post" action="./#fotoboek" enctype="multipart/form-data" class="fotoboek-album-form">
    ...
    <div class="kaart">
      ...
      <form method="post" action="./#rekentabel">
...
?>: jeugd <?php echo euro($volgendJeugd); ?>, senior <?php echo euro($volgendSenior); ?><?php echo $volgendIngevuld ? '' : ' (nog niet vastgesteld, daarom hetzelfde bedrag)'; ?>. Deze tabel en de calculator op aanmelden.html lezen allebei data/rekentabel.json, bewerk hierboven.</p>
              ...
              <?php if ($clEigen): ?>
                ...
                <details>
                  ...
                  <div class="cl-bewerkvak">
                    ...
                    <form method="post" action="./#changelog" onsubmit="return confirm('Deze regel definitief verwijderen?');" style="margin-top:8px;">
  ...
  <script src="../paneel.js?v=<?php echo @filemtime(dirname(__DIR__) . '/paneel.js'); ?>"></script>
  <?php endif; ?>
</body>
</html>
